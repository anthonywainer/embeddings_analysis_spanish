...
def load_stackoverflow(data_path='data/stackoverflow/'):
    # load SO embedding
    with open(data_path + 'vocab_withIdx.dic', 'r', encoding="utf8") as inp_indx, \
            open(data_path + 'vocab_emb_Word2vec_48_index.dic', 'r', encoding="utf8") as inp_dic, \
            open(data_path + 'vocab_emb_Word2vec_48.vec', encoding="utf8") as inp_vec:
    ...
    with open(data_path + 'title_StackOverflow.txt', 'r', encoding="utf8") as inp_txt:
    ...
    with open(data_path + 'label_StackOverflow.txt', encoding="utf8") as label_file:
